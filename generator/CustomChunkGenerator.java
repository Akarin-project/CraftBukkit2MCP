...
public class CustomChunkGenerator extends InternalChunkGenerator<GeneratorSettingsDefault> {
    ...
    public CustomChunkGenerator(World world, long seed, ChunkGenerator generator) {
        ...
        this.chunkManager = world.provider.createChunkGenerator().getWorldChunkManager();
    }
    ...
    public void createChunk(IChunkAccess ichunkaccess) {
        ...
        ExtendedBlockStorage[] sections = ((CraftChunkData) data).getRawChunkData();

        ExtendedBlockStorage[] csect = ichunkaccess.getSections();
        ...
        for (int sec = 0; sec < scnt; sec++) {
            ...
            ExtendedBlockStorage section = sections[sec];
    ...
    @Override
    public BlockPos findNearestMapFeature(World world, String type, BlockPos position, int i) {
    ...
    private final Map<MapGenStructure<? extends WorldGenFeatureConfiguration>, Long2ObjectMap<StructureStart>> structureStartCache = Maps.newHashMap();
    ...
    // Taken from ChunkGeneratorAbstract
    private final Map<MapGenStructure<? extends WorldGenFeatureConfiguration>, Long2ObjectMap<LongSet>> structureCache = Maps.newHashMap();
