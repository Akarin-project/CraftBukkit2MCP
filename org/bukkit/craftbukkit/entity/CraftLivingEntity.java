...
public class CraftLivingEntity extends CraftEntity implements LivingEntity {
    ...
    public boolean addPotionEffect(PotionEffect effect, boolean force) {
        ...
        getHandle().addEffect(new PotionEffect(Potion.getPotionById(effect.getType().getId()), effect.getDuration(), effect.getAmplifier(), effect.isAmbient(), effect.hasParticles()), EntityPotionEffectEvent.Cause.PLUGIN);
        return true;
    }
    ...
    public void removePotionEffect(PotionEffectType type) {
        getHandle().removeEffect(Potion.getPotionById(type.getId()), EntityPotionEffectEvent.Cause.PLUGIN);
    }
    ...
    public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
        ...
        if (Snowball.class.isAssignableFrom(projectile)) {
            ...
            if (TippedArrow.class.isAssignableFrom(projectile)) {
                ...
                launch = new EntityThrownTrident(world, getHandle(), net.minecraft.item.ItemStack.EMPTY);
            } else {
                launch = new EntityTippedArrow(world, getHandle());
            }
    ...
    public void setSwimming(boolean swimming) {
        getHandle().getDistance(swimming);
    }
