...
public class CraftInventoryDoubleChest extends CraftInventory implements DoubleChestInventory {
    ...
    public CraftInventoryDoubleChest(CraftInventory left, CraftInventory right) {
        super(new InventoryLargeChest(new TextComponentTranslation("container.chestDouble"), (ILockableContainer) left.getInventory(), (ILockableContainer) right.getInventory()));
        this.left = left;
        this.right = right;
    }
