...
public class CraftEnchantment extends Enchantment {
    ...
    public CraftEnchantment(net.minecraft.enchantment.Enchantment target) {
        super(CraftNamespacedKey.fromMinecraft(net.minecraft.enchantment.Enchantment.enchantments.b(target)));
        this.target = target;
    }
    ...
    public boolean isCursed() {
        return target instanceof EnchantmentBindingCurse || target instanceof EnchantmentVanishingCurse;
    }
    ...
    public String getName() {
        ...
        switch (net.minecraft.enchantment.Enchantment.enchantments.a(target)) {
        case 0:
