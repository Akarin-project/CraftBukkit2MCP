...
public final class CraftSkullPlayer extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.Rotatable {
    ...
    public CraftSkullPlayer(minecraft.block.state.IBlockState state) {
        super(state);
    }

    // org.bukkit.craftbukkit.block.data.CraftRotatable

    private static final minecraft.block.properties.PropertyInteger ROTATION = getInteger(net.minecraft.server.BlockSkullPlayer.class, "rotation");
