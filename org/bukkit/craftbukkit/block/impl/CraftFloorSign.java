...
public final class CraftFloorSign extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Sign, org.bukkit.block.data.Rotatable, org.bukkit.block.data.Waterlogged {
    ...
    public CraftFloorSign(minecraft.block.state.IBlockState state) {
        super(state);
    }

    // org.bukkit.craftbukkit.block.data.CraftRotatable

    private static final minecraft.block.properties.PropertyInteger ROTATION = getInteger(net.minecraft.block.BlockStandingSign.class, "rotation");
    ...
    private static final minecraft.block.properties.PropertyBool WATERLOGGED = getBoolean(net.minecraft.block.BlockStandingSign.class, "waterlogged");
