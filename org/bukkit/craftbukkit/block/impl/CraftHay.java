...
public final class CraftHay extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.Orientable {
    ...
    public CraftHay(minecraft.block.state.IBlockState state) {
        super(state);
    }

    // org.bukkit.craftbukkit.block.data.CraftOrientable

    private static final minecraft.block.properties.PropertyEnum<?> AXIS = getEnum(net.minecraft.block.BlockHay.class, "axis");
