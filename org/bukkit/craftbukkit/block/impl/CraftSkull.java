...
public final class CraftSkull extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.Rotatable {
    ...
    public CraftSkull(minecraft.block.state.IBlockState state) {
        super(state);
    }

    // org.bukkit.craftbukkit.block.data.CraftRotatable

    private static final minecraft.block.properties.PropertyInteger ROTATION = getInteger(net.minecraft.block.BlockSkull.class, "rotation");
