...
public final class CraftBrewingStand extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.BrewingStand {
    ...
    public CraftBrewingStand(minecraft.block.state.IBlockState state) {
        super(state);
    }

    // org.bukkit.craftbukkit.block.data.type.CraftBrewingStand

    private static final minecraft.block.properties.PropertyBool[] HAS_BOTTLE = new minecraft.block.properties.PropertyBool[]{
        getBoolean(net.minecraft.block.BlockBrewingStand.class, "has_bottle_0"), getBoolean(net.minecraft.block.BlockBrewingStand.class, "has_bottle_1"), getBoolean(net.minecraft.block.BlockBrewingStand.class, "has_bottle_2")
    };
