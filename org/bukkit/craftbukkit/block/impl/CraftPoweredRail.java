...
public final class CraftPoweredRail extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.RedstoneRail, org.bukkit.block.data.Powerable, org.bukkit.block.data.Rail {
    ...
    public CraftPoweredRail(minecraft.block.state.IBlockState state) {
        super(state);
    }

    // org.bukkit.craftbukkit.block.data.CraftPowerable

    private static final minecraft.block.properties.PropertyBool POWERED = getBoolean(net.minecraft.block.BlockRailPowered.class, "powered");
    ...
    private static final minecraft.block.properties.PropertyEnum<?> SHAPE = getEnum(net.minecraft.block.BlockRailPowered.class, "shape");
