    ...
    private void setupSlots(IInventory top, InventoryPlayer bottom, EntityPlayer entityhuman) {
        switch (cachedType) {
            ...
            case WORKBENCH:
                ...
                break;
            case ENCHANTING:
                delegate = new ContainerEnchantment(bottom, entityhuman.world, entityhuman.getChunkCoordinates());
                break;
            case BREWING:
            ...
            case HOPPER:
                ...
                break;
            case ANVIL:
                delegate = new ContainerRepair(bottom, entityhuman.world, entityhuman.getChunkCoordinates(), entityhuman);
                break;
            case BEACON:
