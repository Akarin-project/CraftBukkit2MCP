...
public class CraftEventFactory {
     ...
     * BlockFadeEvent
     */
    public static BlockFadeEvent callBlockFadeEvent(GeneratorAccess world, BlockPos pos, IBlockState newBlock) {
    ...
    public static boolean handleBlockSpreadEvent(World world, BlockPos source, BlockPos target, IBlockState block) {
        return handleBlockSpreadEvent(world, source, target, block, 2);
    }

    public static boolean handleBlockSpreadEvent(World world, BlockPos source, BlockPos target, IBlockState block, int flag) {
    ...
    public static boolean handleBlockGrowEvent(World world, BlockPos pos, IBlockState block) {
        return handleBlockGrowEvent(world, pos, block, 3);
    }

    public static boolean handleBlockGrowEvent(World world, BlockPos pos, IBlockState newData, int flag) {
    ...
    public static EntityChangeBlockEvent callEntityChangeBlockEvent(Entity entity, BlockPos position, IBlockState newBlock) {
        return callEntityChangeBlockEvent(entity, position, newBlock, false);
    }

    public static EntityChangeBlockEvent callEntityChangeBlockEvent(Entity entity, BlockPos position, IBlockState newBlock, boolean cancelled) {
    ...
    public static ProjectileHitEvent callProjectileHitEvent(Entity entity, RayTraceResult position) {
        ...
        if (position.typeOfHit == RayTraceResult.Type.BLOCK) {
            BlockPos blockposition = position.a();
    ...
    public static Cancellable handleStatisticsIncrease(EntityPlayer entityHuman, net.minecraft.stats.StatBase<?> statistic, int current, int incrementation) {
        ...
        if (true) {
            ...
            if (stat.getType() == Type.UNTYPED) {
                ...
                EntityType entityType = CraftStatistic.getEntityTypeFromStatistic((net.minecraft.stats.StatBase<EntityList<?>>) statistic);
    ...
    public static EntityToggleSwimEvent callToggleSwimEvent(EntityLivingBase entity, boolean swimming) {
    ...
    public static boolean handleBlockFormEvent(World world, BlockPos pos, IBlockState block) {
        return handleBlockFormEvent(world, pos, block, 3);
    }

    public static EntityPotionEffectEvent callEntityPotionEffectChangeEvent(EntityLivingBase entity, @Nullable PotionEffect oldEffect, @Nullable PotionEffect newEffect, EntityPotionEffectEvent.Cause cause) {
        return callEntityPotionEffectChangeEvent(entity, oldEffect, newEffect, cause, true);
    }

    public static EntityPotionEffectEvent callEntityPotionEffectChangeEvent(EntityLivingBase entity, @Nullable PotionEffect oldEffect, @Nullable PotionEffect newEffect, EntityPotionEffectEvent.Cause cause, EntityPotionEffectEvent.Action action) {
        return callEntityPotionEffectChangeEvent(entity, oldEffect, newEffect, cause, action, true);
    }

    public static EntityPotionEffectEvent callEntityPotionEffectChangeEvent(EntityLivingBase entity, @Nullable PotionEffect oldEffect, @Nullable PotionEffect newEffect, EntityPotionEffectEvent.Cause cause, boolean willOverride) {
    ...
    public static EntityPotionEffectEvent callEntityPotionEffectChangeEvent(EntityLivingBase entity, @Nullable PotionEffect oldEffect, @Nullable PotionEffect newEffect, EntityPotionEffectEvent.Cause cause, EntityPotionEffectEvent.Action action, boolean willOverride) {
    ...
    public static boolean handleBlockFormEvent(World world, BlockPos pos, IBlockState block, int flag) {
        return handleBlockFormEvent(world, pos, block, flag, null);
    }

    public static boolean handleBlockFormEvent(World world, BlockPos pos, IBlockState block, int flag, @Nullable Entity entity) {
