...
public class CraftBlockState implements BlockState {
    ...
    public static CraftBlockState getBlockState(GeneratorAccess world, minecraft.util.math.BlockPos pos) {
        return new CraftBlockState(CraftBlock.at(world, pos));
    }

    public static CraftBlockState getBlockState(net.minecraft.world.World world, minecraft.util.math.BlockPos pos, int flag) {
    ...
    public void setData(IBlockState data) {
        this.data = data;
    }

    public IBlockState getHandle() {
        return this.data;
    }
    ...
    public boolean update(boolean force, boolean applyPhysics) {
        ...
        IBlockState newBlock = this.data;
