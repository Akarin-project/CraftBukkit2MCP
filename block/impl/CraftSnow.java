...
public final class CraftSnow extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Snow {
    ...
    public CraftSnow(minecraft.block.state.IBlockState state) {
        super(state);
    }

    // org.bukkit.craftbukkit.block.data.type.CraftSnow

    private static final minecraft.block.properties.PropertyInteger LAYERS = getInteger(net.minecraft.block.BlockSnow.class, "layers");
