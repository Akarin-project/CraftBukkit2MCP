...
public final class CraftIronBars extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Fence, org.bukkit.block.data.MultipleFacing, org.bukkit.block.data.Waterlogged {
    ...
    public CraftIronBars(minecraft.block.state.IBlockState state) {
        super(state);
    }
    ...
    private static final minecraft.block.properties.PropertyBool WATERLOGGED = getBoolean(net.minecraft.server.BlockIronBars.class, "waterlogged");
