...
public abstract class CraftNoteBlock extends CraftBlockData implements NoteBlock {
    ...
    private static final minecraft.block.properties.PropertyEnum<?> INSTRUMENT = getEnum("instrument");
    private static final minecraft.block.properties.PropertyInteger NOTE = getInteger("note");
