...
public class ProxiedNativeCommandSender implements ProxiedCommandSender {
    ...
    private final CommandSenderWrapper orig;
    private final CommandSender caller;
    private final CommandSender callee;

    public ProxiedNativeCommandSender(CommandSenderWrapper orig, CommandSender caller, CommandSender callee) {
        this.orig = orig;
        this.caller = caller;
        this.callee = callee;
    }

    public CommandSenderWrapper getHandle() {
        return orig;
    }
